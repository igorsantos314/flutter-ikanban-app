          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (value) {
                  context.read<TaskListBloc>().add(SearchTasksEvent(query: value));
                },
              ),
            ),
            // Task List
                ...
                builder: (context, state) {
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.builder(
                      itemCount: state.tasks.length + (state.hasMorePages ? 1 : 0),
                      itemBuilder: (context, index) {
                        ...
                        if (index == state.tasks.length - 3 && state.hasMorePages && !state.isLoadingMore) {
                          WidgetsBinding.instance.addPostFrameCallback((_) {
