...
mixin _$TaskListState {
 ...
 TaskModel? get selectedTask; String get searchQuery; List<TaskModel> get tasks; bool get isLoading; bool get isLoadingMore; bool get hasMorePages; int get currentPage; bool get hasError; String get errorMessage; bool get showNotification; String get notificationMessage; NotificationType get notificationType; List<TaskStatus> get statusFilter; bool get showStatusSelector;
...
@useResult
$Res call({
 TaskModel? selectedTask, String searchQuery, List<TaskModel> tasks, bool isLoading, bool isLoadingMore, bool hasMorePages, int currentPage, bool hasError, String errorMessage, bool showNotification, String notificationMessage, NotificationType notificationType, List<TaskStatus> statusFilter, bool showStatusSelector
});
...
as List<TaskStatus>,showStatusSelector: null == showStatusSelector ? _self.showStatusSelector : showStatusSelector // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of TaskListState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TaskModel? selectedTask,  String searchQuery,  List<TaskModel> tasks,  bool isLoading,  bool isLoadingMore,  bool hasMorePages,  int currentPage,  bool hasError,  String errorMessage,  bool showNotification,  String notificationMessage,  NotificationType notificationType,  List<TaskStatus> statusFilter,  bool showStatusSelector)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskListState() when $default != null:
return $default(_that.selectedTask,_that.searchQuery,_that.tasks,_that.isLoading,_that.isLoadingMore,_that.hasMorePages,_that.currentPage,_that.hasError,_that.errorMessage,_that.showNotification,_that.notificationMessage,_that.notificationType,_that.statusFilter,_that.showStatusSelector);case _:
  return orElse();
...
@override@JsonKey() final  NotificationType notificationType;
 final  List<TaskStatus> _statusFilter;
@override@JsonKey() List<TaskStatus> get statusFilter {
  if (_statusFilter is EqualUnmodifiableListView) return _statusFilter;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_statusFilter);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaskListState&&(identical(other.selectedTask, selectedTask) || other.selectedTask == selectedTask)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&const DeepCollectionEquality().equals(other._tasks, _tasks)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&(identical(other.hasMorePages, hasMorePages) || other.hasMorePages == hasMorePages)&&(identical(other.currentPage, currentPage) || other.currentPage == currentPage)&&(identical(other.hasError, hasError) || other.hasError == hasError)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.showNotification, showNotification) || other.showNotification == showNotification)&&(identical(other.notificationMessage, notificationMessage) || other.notificationMessage == notificationMessage)&&(identical(other.notificationType, notificationType) || other.notificationType == notificationType)&&const DeepCollectionEquality().equals(other._statusFilter, _statusFilter)&&(identical(other.showStatusSelector, showStatusSelector) || other.showStatusSelector == showStatusSelector));
}


@override
int get hashCode => Object.hash(runtimeType,selectedTask,searchQuery,const DeepCollectionEquality().hash(_tasks),isLoading,isLoadingMore,hasMorePages,currentPage,hasError,errorMessage,showNotification,notificationMessage,notificationType,const DeepCollectionEquality().hash(_statusFilter),showStatusSelector);
...
as bool,notificationMessage: null == notificationMessage ? _self.notificationMessage : notificationMessage // ignore: cast_nullable_to_non_nullable
as String,notificationType: null == notificationType ? _self.notificationType : notificationType // ignore: cast_nullable_to_non_nullable
as NotificationType,statusFilter: null == statusFilter ? _self._statusFilter : statusFilter // ignore: cast_nullable_to_non_nullable
as List<TaskStatus>,showStatusSelector: null == showStatusSelector ? _self.showStatusSelector : showStatusSelector // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
