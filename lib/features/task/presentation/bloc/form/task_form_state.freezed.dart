...
@override
int get hashCode => Object.hash(runtimeType,taskId,title,titleError,description,descriptionError,status,priority,dueDate,complexity,type,showNotification,notificationType,notificationMessage,closeScreen,isLoading,errorMessage);
...
switch (_that) {
case _TaskFormState() when $default != null:
return $default(_that.taskId,_that.title,_that.titleError,_that.description,_that.descriptionError,_that.status,_that.priority,_that.dueDate,_that.complexity,_that.type,_that.showNotification,_that.notificationType,_that.notificationMessage,_that.closeScreen,_that.isLoading,_that.errorMessage);case _:
  return orElse();
