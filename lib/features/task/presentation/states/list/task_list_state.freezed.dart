...
as List<TaskType>,showStatusSelector: null == showStatusSelector ? _self.showStatusSelector : showStatusSelector // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TaskModel? selectedTask,  String searchQuery,  List<TaskModel> tasks,  bool isLoading,  bool isLoadingMore,  bool hasMorePages,  int currentPage,  bool hasError,  String errorMessage,  bool showNotification,  String notificationMessage,  NotificationType notificationType,  TaskStatus statusFilter,  bool showFilterOptions,  List<TaskType> typeFilters,  bool showStatusSelector,  TaskLayout layoutMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskListState() when $default != null:
return $default(_that.selectedTask,_that.searchQuery,_that.tasks,_that.isLoading,_that.isLoadingMore,_that.hasMorePages,_that.currentPage,_that.hasError,_that.errorMessage,_that.showNotification,_that.notificationMessage,_that.notificationType,_that.statusFilter,_that.showFilterOptions,_that.typeFilters,_that.showStatusSelector,_that.layoutMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TaskModel? selectedTask,  String searchQuery,  List<TaskModel> tasks,  bool isLoading,  bool isLoadingMore,  bool hasMorePages,  int currentPage,  bool hasError,  String errorMessage,  bool showNotification,  String notificationMessage,  NotificationType notificationType,  TaskStatus statusFilter,  bool showFilterOptions,  List<TaskType> typeFilters,  bool showStatusSelector,  TaskLayout layoutMode)  $default,) {final _that = this;
switch (_that) {
case _TaskListState():
return $default(_that.selectedTask,_that.searchQuery,_that.tasks,_that.isLoading,_that.isLoadingMore,_that.hasMorePages,_that.currentPage,_that.hasError,_that.errorMessage,_that.showNotification,_that.notificationMessage,_that.notificationType,_that.statusFilter,_that.showFilterOptions,_that.typeFilters,_that.showStatusSelector,_that.layoutMode);case _:
  throw StateError('Unexpected subclass');
...
class _TaskListState implements TaskListState {
  const _TaskListState({this.selectedTask, this.searchQuery = "", final  List<TaskModel> tasks = const [], this.isLoading = false, this.isLoadingMore = false, this.hasMorePages = true, this.currentPage = 1, this.hasError = false, this.errorMessage = "", this.showNotification = false, this.notificationMessage = "", this.notificationType = NotificationType.info, this.statusFilter = TaskStatus.todo, this.showFilterOptions = false, final  List<TaskType> typeFilters = const [], this.showStatusSelector = false, this.layoutMode = TaskLayout.list}): _tasks = tasks,_typeFilters = typeFilters;
...
@override
int get hashCode => Object.hash(runtimeType,selectedTask,searchQuery,const DeepCollectionEquality().hash(_tasks),isLoading,isLoadingMore,hasMorePages,currentPage,hasError,errorMessage,showNotification,notificationMessage,notificationType,statusFilter,showFilterOptions,const DeepCollectionEquality().hash(_typeFilters),showStatusSelector,layoutMode);
