...
mixin _$TaskFormState {
 ...
 int? get taskId; int? get boardId; String get title; String? get titleError; String get description; String? get descriptionError; TaskStatus get status; TaskPriority get priority; DateTime? get dueDate; DateTime? get dueTime; TaskComplexity get complexity; TaskType get type; TaskColors get color; bool get showNotification; NotificationType get notificationType; String get notificationMessage; bool get closeScreen; bool get isLoading; String? get errorMessage;// Checklist fields
...
/// Create a copy of TaskFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? taskId = freezed,Object? boardId = freezed,Object? title = null,Object? titleError = freezed,Object? description = null,Object? descriptionError = freezed,Object? status = null,Object? priority = null,Object? dueDate = freezed,Object? dueTime = freezed,Object? complexity = null,Object? type = null,Object? color = null,Object? showNotification = null,Object? notificationType = null,Object? notificationMessage = null,Object? closeScreen = null,Object? isLoading = null,Object? errorMessage = freezed,Object? checklistItems = null,Object? checklistItemCount = null,}) {
...
as String?,checklistItems: null == checklistItems ? _self.checklistItems : checklistItems // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? taskId,  int? boardId,  String title,  String? titleError,  String description,  String? descriptionError,  TaskStatus status,  TaskPriority priority,  DateTime? dueDate,  DateTime? dueTime,  TaskComplexity complexity,  TaskType type,  TaskColors color,  bool showNotification,  NotificationType notificationType,  String notificationMessage,  bool closeScreen,  bool isLoading,  String? errorMessage,  List<ChecklistItemModel> checklistItems,  int checklistItemCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskFormState() when $default != null:
return $default(_that.taskId,_that.boardId,_that.title,_that.titleError,_that.description,_that.descriptionError,_that.status,_that.priority,_that.dueDate,_that.dueTime,_that.complexity,_that.type,_that.color,_that.showNotification,_that.notificationType,_that.notificationMessage,_that.closeScreen,_that.isLoading,_that.errorMessage,_that.checklistItems,_that.checklistItemCount);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaskFormState&&(identical(other.taskId, taskId) || other.taskId == taskId)&&(identical(other.boardId, boardId) || other.boardId == boardId)&&(identical(other.title, title) || other.title == title)&&(identical(other.titleError, titleError) || other.titleError == titleError)&&(identical(other.description, description) || other.description == description)&&(identical(other.descriptionError, descriptionError) || other.descriptionError == descriptionError)&&(identical(other.status, status) || other.status == status)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.dueTime, dueTime) || other.dueTime == dueTime)&&(identical(other.complexity, complexity) || other.complexity == complexity)&&(identical(other.type, type) || other.type == type)&&(identical(other.color, color) || other.color == color)&&(identical(other.showNotification, showNotification) || other.showNotification == showNotification)&&(identical(other.notificationType, notificationType) || other.notificationType == notificationType)&&(identical(other.notificationMessage, notificationMessage) || other.notificationMessage == notificationMessage)&&(identical(other.closeScreen, closeScreen) || other.closeScreen == closeScreen)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&const DeepCollectionEquality().equals(other._checklistItems, _checklistItems)&&(identical(other.checklistItemCount, checklistItemCount) || other.checklistItemCount == checklistItemCount));
}


@override
int get hashCode => Object.hashAll([runtimeType,taskId,boardId,title,titleError,description,descriptionError,status,priority,dueDate,dueTime,complexity,type,color,showNotification,notificationType,notificationMessage,closeScreen,isLoading,errorMessage,const DeepCollectionEquality().hash(_checklistItems),checklistItemCount]);
...
as bool,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,checklistItems: null == checklistItems ? _self._checklistItems : checklistItems // ignore: cast_nullable_to_non_nullable
as List<ChecklistItemModel>,checklistItemCount: null == checklistItemCount ? _self.checklistItemCount : checklistItemCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
