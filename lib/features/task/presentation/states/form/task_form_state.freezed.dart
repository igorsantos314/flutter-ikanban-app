...
mixin _$TaskFormState {
 ...
 int? get taskId; int? get boardId; String get title; String? get titleError; String get description; String? get descriptionError; TaskStatus get status; TaskPriority get priority; DateTime? get dueDate; DateTime? get dueTime; TaskComplexity get complexity; TaskType get type; TaskColors get color;// Notification fields
 bool get shouldNotify; int? get notifyMinutesBefore; bool get showNotification; NotificationType get notificationType; String get notificationMessage; bool get closeScreen; bool get isLoading; String? get errorMessage;
...
@override
int get hashCode => Object.hashAll([runtimeType,taskId,boardId,title,titleError,description,descriptionError,status,priority,dueDate,dueTime,complexity,type,color,shouldNotify,notifyMinutesBefore,showNotification,notificationType,notificationMessage,closeScreen,isLoading,errorMessage]);

@override
String toString() {
  return 'TaskFormState(taskId: $taskId, boardId: $boardId, title: $title, titleError: $titleError, description: $description, descriptionError: $descriptionError, status: $status, priority: $priority, dueDate: $dueDate, dueTime: $dueTime, complexity: $complexity, type: $type, color: $color, shouldNotify: $shouldNotify, notifyMinutesBefore: $notifyMinutesBefore, showNotification: $showNotification, notificationType: $notificationType, notificationMessage: $notificationMessage, closeScreen: $closeScreen, isLoading: $isLoading, errorMessage: $errorMessage)';
}
...
/// Create a copy of TaskFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? taskId = freezed,Object? boardId = freezed,Object? title = null,Object? titleError = freezed,Object? description = null,Object? descriptionError = freezed,Object? status = null,Object? priority = null,Object? dueDate = freezed,Object? dueTime = freezed,Object? complexity = null,Object? type = null,Object? color = null,Object? shouldNotify = null,Object? notifyMinutesBefore = freezed,Object? showNotification = null,Object? notificationType = null,Object? notificationMessage = null,Object? closeScreen = null,Object? isLoading = null,Object? errorMessage = freezed,}) {
...
as TaskColors,shouldNotify: null == shouldNotify ? _self.shouldNotify : shouldNotify // ignore: cast_nullable_to_non_nullable
...
as int?,showNotification: null == showNotification ? _self.showNotification : showNotification // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _TaskFormState() when $default != null:
return $default(_that.taskId,_that.boardId,_that.title,_that.titleError,_that.description,_that.descriptionError,_that.status,_that.priority,_that.dueDate,_that.dueTime,_that.complexity,_that.type,_that.color,_that.shouldNotify,_that.notifyMinutesBefore,_that.showNotification,_that.notificationType,_that.notificationMessage,_that.closeScreen,_that.isLoading,_that.errorMessage);case _:
  return orElse();
