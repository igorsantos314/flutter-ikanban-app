...
part of 'settings_repository_errors.dart';
...
/// @nodoc
mixin _$SettingsRepositoryErrors {

 String? get message; Object? get throwable;
/// Create a copy of SettingsRepositoryErrors
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SettingsRepositoryErrorsCopyWith<SettingsRepositoryErrors> get copyWith => _$SettingsRepositoryErrorsCopyWithImpl<SettingsRepositoryErrors>(this as SettingsRepositoryErrors, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsRepositoryErrors&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.throwable, throwable));
}
...
@override
String toString() {
  return 'SettingsRepositoryErrors(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class $SettingsRepositoryErrorsCopyWith<$Res>  {
  factory $SettingsRepositoryErrorsCopyWith(SettingsRepositoryErrors value, $Res Function(SettingsRepositoryErrors) _then) = _$SettingsRepositoryErrorsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$SettingsRepositoryErrorsCopyWithImpl<$Res>
    implements $SettingsRepositoryErrorsCopyWith<$Res> {
  _$SettingsRepositoryErrorsCopyWithImpl(this._self, this._then);

  final SettingsRepositoryErrors _self;
  final $Res Function(SettingsRepositoryErrors) _then;
...
/// Adds pattern-matching-related methods to [SettingsRepositoryErrors].
extension SettingsRepositoryErrorsPatterns on SettingsRepositoryErrors {
...
class _NotFound implements SettingsRepositoryErrors {
...
@override
String toString() {
  return 'SettingsRepositoryErrors.notFound(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$NotFoundCopyWith<$Res> implements $SettingsRepositoryErrorsCopyWith<$Res> {
...
class _DatabaseError implements SettingsRepositoryErrors {
...
@override
String toString() {
  return 'SettingsRepositoryErrors.databaseError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$DatabaseErrorCopyWith<$Res> implements $SettingsRepositoryErrorsCopyWith<$Res> {
...
class _ValidationError implements SettingsRepositoryErrors {
...
@override
String toString() {
  return 'SettingsRepositoryErrors.validationError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$ValidationErrorCopyWith<$Res> implements $SettingsRepositoryErrorsCopyWith<$Res> {
...
class _NetworkError implements SettingsRepositoryErrors {
...
@override
String toString() {
  return 'SettingsRepositoryErrors.networkError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$NetworkErrorCopyWith<$Res> implements $SettingsRepositoryErrorsCopyWith<$Res> {
...
class _GenericError implements SettingsRepositoryErrors {
...
@override
String toString() {
  return 'SettingsRepositoryErrors.genericError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$GenericErrorCopyWith<$Res> implements $SettingsRepositoryErrorsCopyWith<$Res> {
