...
part of 'board_repository_errors.dart';
...
/// @nodoc
mixin _$BoardRepositoryErrors {

 String? get message; Object? get throwable;
/// Create a copy of BoardRepositoryErrors
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BoardRepositoryErrorsCopyWith<BoardRepositoryErrors> get copyWith => _$BoardRepositoryErrorsCopyWithImpl<BoardRepositoryErrors>(this as BoardRepositoryErrors, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BoardRepositoryErrors&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.throwable, throwable));
}
...
@override
String toString() {
  return 'BoardRepositoryErrors(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class $BoardRepositoryErrorsCopyWith<$Res>  {
  factory $BoardRepositoryErrorsCopyWith(BoardRepositoryErrors value, $Res Function(BoardRepositoryErrors) _then) = _$BoardRepositoryErrorsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BoardRepositoryErrorsCopyWithImpl<$Res>
    implements $BoardRepositoryErrorsCopyWith<$Res> {
  _$BoardRepositoryErrorsCopyWithImpl(this._self, this._then);

  final BoardRepositoryErrors _self;
  final $Res Function(BoardRepositoryErrors) _then;
...
/// Adds pattern-matching-related methods to [BoardRepositoryErrors].
extension BoardRepositoryErrorsPatterns on BoardRepositoryErrors {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _NotFound value)?  notFound,TResult Function( _DatabaseError value)?  databaseError,TResult Function( _ValidationError value)?  validationError,TResult Function( _NetworkError value)?  networkError,TResult Function( GenericError value)?  genericError,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return networkError(_that);case GenericError() when genericError != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _NotFound value)  notFound,required TResult Function( _DatabaseError value)  databaseError,required TResult Function( _ValidationError value)  validationError,required TResult Function( _NetworkError value)  networkError,required TResult Function( GenericError value)  genericError,}){
final _that = this;
switch (_that) {
case _NotFound():
...
return networkError(_that);case GenericError():
return genericError(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _NotFound value)?  notFound,TResult? Function( _DatabaseError value)?  databaseError,TResult? Function( _ValidationError value)?  validationError,TResult? Function( _NetworkError value)?  networkError,TResult? Function( GenericError value)?  genericError,}){
final _that = this;
switch (_that) {
case _NotFound() when notFound != null:
return notFound(_that);case _DatabaseError() when databaseError != null:
...
return networkError(_that.message,_that.throwable);case GenericError() when genericError != null:
...
return networkError(_that.message,_that.throwable);case GenericError():
return genericError(_that.message,_that.throwable);case _:
  throw StateError('Unexpected subclass');
...
class _NotFound implements BoardRepositoryErrors {
...
@override
String toString() {
  return 'BoardRepositoryErrors.notFound(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$NotFoundCopyWith<$Res> implements $BoardRepositoryErrorsCopyWith<$Res> {
...
class _DatabaseError implements BoardRepositoryErrors {
...
@override
String toString() {
  return 'BoardRepositoryErrors.databaseError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$DatabaseErrorCopyWith<$Res> implements $BoardRepositoryErrorsCopyWith<$Res> {
...
class _ValidationError implements BoardRepositoryErrors {
...
@override
String toString() {
  return 'BoardRepositoryErrors.validationError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$ValidationErrorCopyWith<$Res> implements $BoardRepositoryErrorsCopyWith<$Res> {
...
class _NetworkError implements BoardRepositoryErrors {
...
@override
String toString() {
  return 'BoardRepositoryErrors.networkError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class _$NetworkErrorCopyWith<$Res> implements $BoardRepositoryErrorsCopyWith<$Res> {
...
class GenericError implements BoardRepositoryErrors {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GenericError&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.throwable, throwable));
}
...
@override
String toString() {
  return 'BoardRepositoryErrors.genericError(message: $message, throwable: $throwable)';
}
...
/// @nodoc
abstract mixin class $GenericErrorCopyWith<$Res> implements $BoardRepositoryErrorsCopyWith<$Res> {
